...
3. **Таблица уроков:**
   ...
   - Столбец Действия:
     ...
     - 🗑️ Удалить → модальное окно подтверждения
...
│  Все связанные записи об оценках         │
│  учеников также будут удалены.           │
│                                          │
│                                          │
│  [  Отмена  ]    [  Удалить урок  ]      │
│                                          │
...
**Сценарий 3 (Admin удаляет урок):**
1. Admin находит урок, который нужно удалить
2. Нажимает 🗑️ (Удалить)
3. Видит модальное окно подтверждения
4. Читает предупреждение
5. Нажимает "Удалить урок"
6. Урок исчезает из списка
7. Видит уведомление "Урок успешно удалён"
...
- Автоматический расчёт баллов за каждый урок:
  ...
  - Тест: балл * 1 (макс 10)
  - Тетрадь: балл * 1 (макс 10)
  - Спевка: 3 балла
  - **Итого за урок: до 34 баллов**
