...
3. **Таблица уроков:**
   ...
   - Столбец Действия:
     ...
     - 🗑️ Удалить → модальное окно подтверждения удаления
...
5. **Действия:**
   - Клик на строку → модальное окно с полным текстом
   - Клик на ✏️ → модальное окно редактирования текста
   - Клик на ссылку → переход на страницу статистики для этого стиха

**Модальное окно "Просмотр стиха":**
```
┌───────────────────────────────────────────────────┐
│ Быт. 22:14                                [✕]    │
├───────────────────────────────────────────────────┤
