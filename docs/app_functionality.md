...
3. При завершении года все страницы уроков становятся read-only
4. Создание нового года предлагает автозаполнение дат (01.09 — 31.05) и копирование настроек группы
