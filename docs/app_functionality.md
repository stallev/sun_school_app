...
╠═══════════════════════════════════════════════════════════════════════╣
║                                                                       ║
║  📚 Учебные годы по группам                                           ║
║  ═════════════════════════════════════════════════════════════        |   
║  [Завершить текущий год]   [Создать новый год 2025-2026]              |
║                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────┐  ║
║  │ Группа: Младшая (6-8)                                           │  ║
║  │ Текущий год: 2024-2025  Статус: 🟢 ACTIVE                       │  ║
║  │ Даты: 01.09.2024 — 31.05.2025                                   │  ║
║  │ Уроков создано: 36                                              │  ║
║  └─────────────────────────────────────────────────────────────────┘  ║
║                                                                       ║
║  ┌─────────────────────────────────────────────────────────────────┐  ║
║  │ Группа: Средняя (9-11)                                           │  ║
║  │ Текущий год: 2024-2025  Статус: 🟡 FINISHED                      │ ║
║  │ Даты: 01.09.2024 — 31.05.2025                                   │  ║
║  │ Уроков создано: 34                                              │  ║
║  └─────────────────────────────────────────────────────────────────┘  ║
║                                                                       ║
...
**Правила:**
1. Одновременно у каждой группы может быть только один год в статусе ACTIVE
...
2. Видит, что у "Младшая (6-8)" статус 🟢 ACTIVE
3. Нажимает "Завершить текущий год" → подтверждает
4. Статус меняется на 🟡 FINISHED, кнопка создания активируется
5. Нажимает "Создать новый год 2025-2026" → подтверждает
6. Создаётся запись AcademicYear(2025-2026, status=ACTIVE)
7. Учителя могут создавать уроки уже в новом году
