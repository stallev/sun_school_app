...
### 4.2.1 Архив уроков (/year-lessons-list/archive/:gradeId)

**Доступ:** Teacher (для своих групп), Admin (для всех групп)

**Назначение:** Просмотр и восстановление архивированных уроков выбранной группы за весь период, сгруппированных по учебным годам
...
- Открывает /year-lessons-list/archive/:gradeId
...
- Золотые стихи загружены с текущими значениями:
...
11. Возвращается на /year-lessons-list
