...
### 5.5 Архив уроков (Admin) (/admin/lessons-archive)

**Доступ:** Admin, Superadmin

**Назначение:** Централизованный просмотр архивных уроков по всем группам и учебным годам; обработка запросов на восстановление

**Wireframe:**
```
╔═══════════════════════════════════════════════════════════════════════╗
║ 🏠 Dashboard > Архив уроков                                          ║
╠═══════════════════════════════════════════════════════════════════════╣
║                                                                       ║
║  Фильтры:  [Группа: Все ▼]  [Учебный год: Все ▼]  [Статус: Все ▼]    ║
║            [🔍 Поиск по теме...]                                       ║
║                                                                       ║
║  📦 Архивные уроки                                                     ║
║  ─────────────────────────────────────────────────────────            ║
║  ┌─────────────────────────────────────────────────────────────────┐  ║
║  │ № │ Группа │ Год       │ Дата      │ Тема             │ Статус │  ║
║  ├───┼────────┼───────────┼───────────┼──────────────────┼────────┤  ║
║  │ 7 │ Младш. │ 2024-2025 │ 13.10.24  │ Вавилонская ...  │ archived│  ║
║  ├───┼────────┼───────────┼───────────┼──────────────────┼────────┤  ║
║  │12 │ Средн. │ 2023-2024 │ 17.11.24  │ Иосиф в Египте   │ requested│  ║
║  └───┴────────┴───────────┴───────────┴──────────────────┴────────┘  ║
║                                                                       ║
║  📨 Запросы на восстановление                                          ║
║  ─────────────────────────────────────────────────────────            ║
║  ┌─────────────────────────────────────────────────────────────────┐  ║
║  │ # │ Группа │ Год       │ Урок (дата/тема)     │ Действия       │  ║
║  ├──┼────────┼───────────┼───────────────────────┼────────────────┤  ║
║  │ 1│ Средн. │ 2023-2024 │ 17.11.24 "Иосиф..."  │ [Одобрить] [Отклонить] │║
║  └──┴────────┴───────────┴───────────────────────┴────────────────┘  ║
║                                                                       ║
╚═══════════════════════════════════════════════════════════════════════╝
```
...
**Элементы интерфейса:**
- Фильтры: группа, учебный год, статус (archived/requestedForRestore)
- Таблица архивных уроков (все группы)
- Секция запросов на восстановление: список уроков в статусе requestedForRestore с действиями

**Сценарии:**
1) Admin фильтрует архивные уроки
- Выбирает группу и год, вводит тему, видит отфильтрованный список

2) Admin обрабатывает запрос на восстановление
- Открывает секцию запросов
- Жмёт "Одобрить" → статус урока меняется на published
- Жмёт "Отклонить" → статус меняется на archived (с журналированием причины — Future)
