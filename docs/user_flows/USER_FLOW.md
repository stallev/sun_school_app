...
> [!NOTE]
> **Детальное описание роли:** См. [app_functionality.md](../app_functionality.md#22-admin-администратор)

**Краткое описание:** Администратор воскресной школы с полным доступом к управлению
...
> [!NOTE]
> **Детальное описание роли:** См. [app_functionality.md](../app_functionality.md#23-superadmin-главный-администратор)

**Краткое описание:** Главный администратор с максимальными правами
