...
> **СПРАВОЧНЫЙ ДОКУМЕНТ**
> 
> Этот документ сохранен исключительно для справочных целей. Актуальная архитектура проекта описана в [`docs/prds/ARCHITECTURE.md`](../prds/ARCHITECTURE.md).
> 
> Данный документ описывает подход к деплою через GitHub Actions, который был заменен на ручной деплой через Amplify/SAM CLI (см. [`docs/DEPLOYMENT_GUIDE.md`](../DEPLOYMENT_GUIDE.md)).
...
> ⚠️ **УСТАРЕЛО**: Этот документ описывает устаревший подход к деплою через GitHub Actions. Для актуальной информации см. [`docs/prds/ARCHITECTURE.md`](../prds/ARCHITECTURE.md) и [`docs/DEPLOYMENT_GUIDE.md`](../DEPLOYMENT_GUIDE.md).
