...
**Действия:**
- [x] Убедиться, что в schema включен `@versioned` для типов, требующих оптимистичной блокировки
- [x] Проверить настройку conflict detection в Amplify
- [x] Протестировать работу conflict detection при одновременных обновлениях
