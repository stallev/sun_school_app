...
**Описание:** Реализация управления уроками: создание, редактирование, просмотр, удаление. Интеграция с Novel редактором для описания урока, выбор золотых стихов.
